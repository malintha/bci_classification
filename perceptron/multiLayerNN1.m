clear;
clc;
data= load_data('k3b', 0.9, 1);%k3b.mat k6b.mat l1b.mat
data2= load_data('k6b', 0.1, 1);%k3b.mat k6b.mat l1b.mat
data3= load_data('l1b', 0.1, 1);%k3b.mat k6b.mat l1b.mat
...
learningRate=0.000001   ;%learningRate=0.00001; inner layer 35
