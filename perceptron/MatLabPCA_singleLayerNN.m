clear;
clc;
data= load_data('k3b', 0.6, 1);%k3b.mat k6b.mat l1b.mat
...
%figure, plot(diag(DTest));
%PCA dimention reduction
[dimRedDataTrain,SCORE] = pca(dataTrain,'NumComponents', M);
[dimRedDataTest,SCORE] = pca(dataTest,'NumComponents', M);
dimRedDataTrain=dimRedDataTrain';
dimRedDataTest=dimRedDataTest';
%NN parameters
%%%%%Train NN using OXtr%%%%%%%%
X_input = dimRedDataTrain; 
Y_label =getOnehotVectorMode(Ytr);
learningRate=0.01;%learningRate=0.000001;
iterations=1000000;
